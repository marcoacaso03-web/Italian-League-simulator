  ...
  return (
    <div className="rounded-2xl border border-emerald-500/30 bg-[#0d1f18] p-4 space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={onCancel}
          className="text-xs font-semibold text-slate-400 border border-slate-600 rounded-lg px-3 py-1.5 hover:text-white hover:border-slate-400 transition-colors"
        >
          Cancel
        </button>
      </div>
          ...
          {availableSlots.map((s) => {
            ...
            return (
              <button
                ...
                onClick={() => onPick(s.formationSlot.id)}
          ...
          <div className="flex flex-wrap gap-1.5">
            {unavailable.map((s) => {
              ...
              return (
                <span
                  key={s.formationSlot.id}
                  className="text-[11px] font-semibold text-slate-500 border border-slate-700 rounded-lg px-2.5 py-1.5"
                >
                  {abbr} · {occupant}
                </span>
              );
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1">
                Pick any player, then choose which open position to slot them into.
              </p>
            </div>
            ...
            <div className="flex gap-2 pt-1">
              ...
              <button onClick={cancel} className="flex-1 py-3 rounded-xl text-slate-400 text-sm hover:text-white transition-colors">
                Annulla
              </button>
            </div>
          </div>
