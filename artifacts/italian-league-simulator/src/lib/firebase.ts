...
const firebaseConfig = {
  ...
  projectId:         import.meta.env.FirebaseProjectId           ?? import.meta.env.VITE_FIREBASE_PROJECT_ID         ?? '',
  storageBucket:     import.meta.env.FirebaseStorageBucket       ?? import.meta.env.VITE_FIREBASE_STORAGE_BUCKET     ?? '',
  messagingSenderId: import.meta.env.FirebaseMessagingSenderId   ?? import.meta.env.VITE_FIREBASE_MESSAGING_SENDER_ID ?? '',
  appId:             import.meta.env.FirebaseAppId               ?? import.meta.env.VITE_FIREBASE_APP_ID             ?? '',
};
